...
public class Contact extends JFrame {
	...
	public Contact() {
		...
		setIconImage(new ImageIcon(getClass().getResource("ct.jpg")).getImage());
		...
		btnContact.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(frame.getComponent(0),
						"<html>Your feedback has been sent to admin <br><br>"
								+ "<i>Thank you for choosing my application</i><br><br>" + "Ender Phan</html>");
				// get Feedback
