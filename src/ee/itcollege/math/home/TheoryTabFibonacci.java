...
public class TheoryTabFibonacci extends JPanel {
	...
	public TheoryTabFibonacci() {
		...
		JPanel jplInnerPanel1 = createInnerPanel("<html>" + "<br><h2>Fibonacci number Theory</h2><br>"
				...
				+ "<br>or often in modern usage<br>" + "0, 1, 1, 2, 5, 8, 13, 21, 34, 66, 89, 144<br>"
				...
				+ " F(n)= F(n-1)+F(n-2)<br>" + "<br><br>" + "with seed values<br>" + "F1=1<br>" + "<br>F2=1"
